...
path_images = "./data/caltech-101/101_ObjectCategories/airplanes/"
path_annot = "./data/caltech-101/Annotations/Airplanes_Side_2/"
...
path_to_downloaded_file = keras.utils.get_file(
    ...
    cache_dir="/data/caltech-101",  # cache and extract in current directory
)
...
for i in range(0, len(annot_files)):
    ...
    annot = scipy.io.loadmat(path_annot + annot_files[i])["box_coord"][0]
...
print(patches.shape, f"{patches.shape[1]} patches per image \n{patches.shape[-1]} elements per patch")
...
class PatchEncoder(layers.Layer):
    ...
    def call(self, patch):
        ...
        #print(positions, patch.shape, projected_patches.shape, encoded.shape)
