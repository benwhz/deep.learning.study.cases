...
#print(model)
#pp.pprint(model)
content_image = mpimg.imread("images/louvre.jpg")
plt.imshow(content_image)
style_image = mpimg.imread("images/monet_800600.jpg")
imshow(style_image)
...
print("J_style_layer = ", J_style_layer)
...
J = total_cost(J_content, J_style_layer)
print("J = ", J)


content_image = mpimg.imread("images/louvre_small.jpg")
content_image = reshape_and_normalize_image(content_image)
style_image = mpimg.imread("images/monet.jpg")
